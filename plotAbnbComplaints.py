...
x = []
# this list will contain all the Complaint deltas per capita
y = []
# this list will contain all the areas for the circumferences 
areas = []

# read in the file that compares deltas for Airbnbs and deltas for Complaints per each zipcode
file = open("zipAbnbComplaint.txt")
line = file.readline()
...
while line:
    ...
    x += [float(fields[2])]
    # add the Complaint delta to the y values
